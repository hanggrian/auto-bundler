...
internal enum class BundleValueType(val typeName: TypeName, private val methodName: String) {
    ...
    INT_ARRAYLIST(
        ParameterizedTypeName.get(ArrayList::class.java, Integer::class.java),
        "IntegerArrayList"
    ),
    ...
    CHARSEQUENCE_ARRAYLIST(
        ParameterizedTypeName.get(
            ArrayList::class.java, CharSequence::class.java
        ),
        "CharSequenceArrayList"
    ),
    PARCELABLE(com.hendraanggrian.auto.bundles.compiler.PARCELABLE, "Parcelable"),
    PARCELABLE_ARRAY(ArrayTypeName.of(com.hendraanggrian.auto.bundles.compiler.PARCELABLE), "ParcelableArray"),
    PARCELABLE_ARRAYLIST(
        ParameterizedTypeName.get(
            ClassName.get(ArrayList::class.java),
            com.hendraanggrian.auto.bundles.compiler.PARCELABLE
        ),
        "ParcelableArrayList"
    ),
    PARCELABLE_SPARSEARRAY(
        ParameterizedTypeName.get(SPARSE_ARRAY, com.hendraanggrian.auto.bundles.compiler.PARCELABLE),
    ...
    companion object {
        ...
        fun valueOf(fieldElement: Element, typeUtils: Types): BundleValueType {
            ...
            MoreTypes.asTypeElement(fieldElement.asType()).annotationMirrors
                .filter { TypeName.get(it.annotationType) == PARCEL }
                .forEach { _ -> return PARCELER }
