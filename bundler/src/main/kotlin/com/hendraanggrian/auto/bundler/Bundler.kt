...
import com.hendraanggrian.auto.bundler.internal.BundleBinding
...
object Bundler {
    ...
    internal var BINDINGS: MutableMap<String, Constructor<BundleBinding>>? = null
     ...
     */
    fun bindExtras(source: Intent, target: Any): Unit =
    ...
    private fun findBindingConstructor(
        cls: Class<*>,
        clsSuffix: String,
        paramTypes: Array<Class<*>>
