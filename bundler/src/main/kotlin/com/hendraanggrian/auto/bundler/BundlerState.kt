...
inline fun androidx.fragment.app.Fragment.restoreStates(source: Bundle): Unit =
    Bundler.restoreStates(source, this)
...
inline fun androidx.fragment.app.Fragment.saveStates(source: Bundle): Bundle =
    Bundler.saveStates(source, this)
