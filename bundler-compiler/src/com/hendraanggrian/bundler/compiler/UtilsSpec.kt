...
internal class UtilsSpec : Spec {
    ...
    init {
        ...
        val parameterSpecs = listOf(
            ParameterSpec.builder(BUNDLE, SOURCE)
        ...
        this.typeSpec = TypeSpec.classBuilder(BUNDLER_UTILS.simpleName())
        ...
        this.methodSpecGet = MethodSpec.methodBuilder("getParceler")
            ...
            .addParameter(
                ParameterSpec.builder(generic, DEFAULT_VALUE)
        ...
        this.methodSpecPut = MethodSpec.methodBuilder("putParceler")
            ...
            .addParameters(parameterSpecs)
            .addParameter(
                ParameterSpec.builder(generic, VALUE)
                    .addAnnotation(NonNull::class.java)
                    .build()
            )
            .addStatement("$SOURCE.putParcelable($KEY, \$$GENERIC.wrap($VALUE))", PARCELS)
    }
